...
<?php else: ?>
    <div class="imageAttachment" id="<?php echo $this->id ?>">
        ...
        <div class="btn-toolbar actions-bar">
            ...
            <?php if ($this->crop): ?>
                <span class="btn disabled crop_image">
                    <i class="icon-zoom-in"></i> <?php echo Yii::t('ImageAttachmentWidget.main', 'Crop'); ?></span>
            <?php endif; ?>
        </div>
        <div class="overlay">
            ...
            <div class="drop-hint">
                <span class="drop-hint-info">
                    <?php echo Yii::t('ImageAttachmentWidget.main', 'Drop Image Here…'); ?></span>
            </div>
        </div>
